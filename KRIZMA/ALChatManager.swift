...
class ALChatManager: NSObject {
    ...
    static let applicationId = ChatAPIKey
    ...
    func registerUserAndLaunchChat(_ alUser:ALUser?, fromController:UIViewController,forUser:String?)
    {
        ...
        if(!ALChatManager.isNilOrEmpty(ALUserDefaultsHandler.getDeviceKeyString() as NSString?))
        {
            if (ALChatManager.isNilOrEmpty(forUser as NSString?))
            {
                ...
                let notifVC = storyboard.instantiateViewController(withIdentifier: "NotificationsVC") as! NotificationsVC
                let searchVC = storyboard.instantiateViewController(withIdentifier: "SearchViewController") as! SearchViewController
                let favVC = storyboard.instantiateViewController(withIdentifier: "FavouritesVC") as! FavouritesVC
                let profileVC = storyboard.instantiateViewController(withIdentifier: "MenuProfileVC") as! MenuProfileVC
...
//                alChatLauncher.launchChatList(title, andViewControllerObject:fromController)
                alChatLauncher.launchChatList(title, andViewControllerObject: fromController, vc1: searchVC, vc2: favVC, vc3: profileVC, vc4: notifVC)
            }
            else
            {
