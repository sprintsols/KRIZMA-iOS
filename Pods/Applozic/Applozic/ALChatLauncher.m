    ...
    andViewControllerObject:(UIViewController *)viewController andWithText:(NSString *)text
{
    ...
    if(groupID){
        ...
        chatView.authorVC = viewController;
        chatView.fromMessageList = NO;
        
        [viewController.navigationController pushViewController:chatView animated:YES];
...
-(void)launchChatList:(NSString *)title andViewControllerObject:(UIViewController *)viewController VC1:(UIViewController *)vc1 VC2:(UIViewController *)vc2 VC3:(UIViewController *)vc3 VC4:(UIViewController *)vc4
{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Applozic" bundle:[NSBundle bundleForClass:ALChatViewController.class]];
...
//    ALMessagesViewController * msgVC = (ALMessagesViewController *)[[navBAR viewControllers] objectAtIndex:0];
    ALMessagesViewController * msgVC = (ALMessagesViewController *)[storyboard instantiateViewControllerWithIdentifier: @"ALViewController"];
    ...
    [viewController.navigationController pushViewController:msgVC animated:NO];
