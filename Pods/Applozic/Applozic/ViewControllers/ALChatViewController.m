...
-(void)viewDidLoad
{
    ...
    _lblName.text = [self.alContact getDisplayName];

    dispatch_async(dispatch_get_main_queue(), ^{
        if(self.alContact.contactImageUrl)
         {
            [_imgView sd_setImageWithURL:self.alContact.contactImageUrl placeholderImage:nil options:SDWebImageRefreshCached];
         }
    });
}
...
-(IBAction)backBtnAction:(id)sender
{
    if (_fromMessageList)
     ...
     {
        [_authorVC.navigationController popViewControllerAnimated:YES];
     }
}
...
//==============================================================================================================================================
#pragma mark - AUDIO/VIDEO CALL HANDLER
//==============================================================================================================================================
...
-(IBAction)audioCallBtnAction:(id)sender
{
    if(!self.channelKey && !self.conversationId && [ALApplozicSettings isAudioVideoEnabled])
     {
